...
const doctors = [
  { id: 1, name: 'Dr. Sarah Johnson', specialty: 'Cardiologist', available: true, rating: 4.8 },
  { id: 2, name: 'Dr. Michael Chen', specialty: 'Neurologist', available: false, rating: 4.6 },
  { id: 3, name: 'Dr. Emily Rodriguez', specialty: 'Pediatrician', available: true, rating: 4.9 },
  { id: 4, name: 'Dr. James Wilson', specialty: 'Dermatologist', available: true, rating: 4.7 },
  { id: 5, name: 'Dr. Lisa Patel', specialty: 'Oncologist', available: false, rating: 4.5 },
  { id: 6, name: 'Dr. Robert Taylor', specialty: 'Orthopedist', available: true, rating: 4.4 },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        ...
        >
          <Text style={[styles.filterText, filter === 'unavailable' && styles.activeFilterText]}>Unavailable</Text>
        </TouchableOpacity>
      </View>
